        ...
        <div className={styles.top}>
          ...
          <div className={styles.body}>
            <Box sx={{ width: '100%', typography: 'body1' }}>
              <Tbs value={value} onChange={handleChange} centered className={styles.tabs} TabIndicatorProps={{style: {background:'#800000', height: "2px"}}}
              sx={{"& button.Mui-selected": {color: "#800000"}}}>
                <Tab label="All" />
                <Tab label="TV" />
                <Tab label="COMPUTERS" />
